...
describeBuilt("server entries in dist", () => {
  ...
  test("declares the public contract", () => {
    ...
    for (const name of [
      ...
      "NajmPreferenceCurrency",
      "NajmCookieReader",
      "NajmPreferenceSource",
      "NajmOrderedPreference",
      "NajmCurrencyPreference",
      "NajmInstitutionalPreferences",
      "NajmOrderedResolveInput",
      "NajmOrderedPreferenceSnapshot",
      "NajmPreferenceRoutes",
      "NajmPreferenceRoute",
