...
export const SelectInput: React.FC<SelectInputProps> = ({ placeholder = "", value, onChange, icon, showIcon = true, iconColor, items, className = "", variant = "default", status = "default", bordered, borderDegree, borderColor, disabled = false }) => {
  ...
  return (
    <div className={cn("relative", className)}>
      <BaseInput variant={variant} status={status} bordered={bordered} borderDegree={borderDegree} borderColor={borderColor} className="pointer-events-none">
