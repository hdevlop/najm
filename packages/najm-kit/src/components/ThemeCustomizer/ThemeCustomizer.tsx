      ...
      <div className="border-t border-border pt-4">
        <ThemeCustomizerComponentsLayoutTab
          ...
          labels={{
            ...
            sidebarSections: resolveLabel("sidebarSections", labels),
            sidebarNoSections: resolveLabel("sidebarNoSections", labels),
            ...
            sidebarExpandedWidth: resolveLabel("sidebarExpandedWidth", labels),
            sidebarCollapsedWidth: resolveLabel("sidebarCollapsedWidth", labels),
            sidebarMobileWidth: resolveLabel("sidebarMobileWidth", labels),
            tableHeaderColor: resolveLabel("tableHeaderColor", labels),
            tableHeaderTextColor: resolveLabel("tableHeaderTextColor", labels),
            tableBorderColor: resolveLabel("tableBorderColor", labels),
