...
export type SpinnerVariant = "default" | "circle" | "pinwheel" | "circle-filled" | "ellipsis" | "ring" | "bars" | "infinite";

export interface NSpinnerProps extends LucideProps {
  variant?: SpinnerVariant;
  size?: number;
}

type SpinnerVariantProps = Omit<NSpinnerProps, "variant">;
...
const Bars = ({ size = 24, ...props }: SpinnerVariantProps) => (
  <svg height={size} viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Loading...</title>
    <rect fill="currentColor" height="4" rx="1" width="4" x="1" y="10">
      <animate attributeName="opacity" begin="0s" dur="0.6s" keyTimes="0;0.5;1" repeatCount="indefinite" values="1;0.3;1" />
    </rect>
    <rect fill="currentColor" height="4" rx="1" width="4" x="10" y="10">
      <animate attributeName="opacity" begin="0.1s" dur="0.6s" keyTimes="0;0.5;1" repeatCount="indefinite" values="1;0.3;1" />
    </rect>
    <rect fill="currentColor" height="4" rx="1" width="4" x="19" y="10">
      <animate attributeName="opacity" begin="0.2s" dur="0.6s" keyTimes="0;0.5;1" repeatCount="indefinite" values="1;0.3;1" />
    </rect>
  </svg>
);
...
const spinnerVariants: Record<SpinnerVariant, React.FC<SpinnerVariantProps>> = {
  default: Default,
  circle: Circle,
  pinwheel: Pinwheel,
...
export function NSpinner({ variant = "default", size = 24, className, ...props }: NSpinnerProps) {
