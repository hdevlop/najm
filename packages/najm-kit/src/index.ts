...
export { DEFAULT_STATUS_KEY_PREFIX, DEFAULT_STATUS_LABEL_LANGUAGE, NAJM_STATUS_LABELS, findPackagedStatusLabel, findStatusLabel, formatStatusLabel, resolveStatusLabelLanguage } from "./components/Badge";
export type { BadgeColor, BadgeIcon, BadgeLook, BadgeProps, BadgeShape, BadgeSize, BadgeVariant, NajmStatusLabelOptions, NBadgeDefaults, NBadgeLook, NBadgeProps } from "./components/Badge";
