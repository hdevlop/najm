  ...
  return (
    <div className="space-y-6 max-w-md">
      ...
      <div className="space-y-3">
        ...
        <div>
          <label className="text-sm font-medium mb-1 block">Border styles</label>
          <div className="space-y-2">
            <TextInput value="" onChange={() => {}} variant="default" placeholder="Default (rounded-md)" />
            <TextInput value="" onChange={() => {}} variant="rounded" placeholder="Rounded (rounded-full)" />
            <TextInput value="" onChange={() => {}} variant="ghost" placeholder="Ghost (borderless)" />
          </div>
        </div>
        <div>
