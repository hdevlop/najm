...
import { Slider } from 'najm-ui';
import { NativeSelect as Select } from 'najm-ui';
import { Switch } from 'najm-ui';
    ...
    <>
      <div className="rounded-lg border border-border bg-card/70 p-4">
        ...
        <Alert variant="warning" className="p-3">
          <AlertIcon variant="warning" className="h-4 w-4" />
          <div>
            <AlertTitle>Changes apply immediately.</AlertTitle>
            <AlertDescription className="text-xs">Use care when editing live routing thresholds.</AlertDescription>
          </div>
        </Alert>
      </>
    );
