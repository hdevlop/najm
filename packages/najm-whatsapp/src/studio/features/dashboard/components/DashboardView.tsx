...
import { NPageHeader, NEmptyState, Button, NStatCard } from 'najm-ui';
    ...
    >
      <div className="flex h-full flex-col gap-5 p-5">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          <NStatCard icon={MessageSquare} label="Total Messages" value={totalMessages.toLocaleString()} change={{ value: '12.5%', positive: true }} />
          <NStatCard icon={Server} label="Instances" value={String(instances.length || 6)} change={{ value: '50%', positive: true }} />
          <NStatCard icon={Plug} label="Connected" value={String(connectedCount || 3)} change={{ value: '33%', positive: true }} />
          <NStatCard icon={Zap} label="Events/min" value="42" change={{ value: '8.2%', positive: true }} />
          <NStatCard icon={Users} label="Contacts" value="20" change={{ value: '5.3%', positive: true }} />
          <NStatCard icon={Webhook} label="Services OK" value="5/6" change={{ value: '0%', positive: true }} />
        </div>
