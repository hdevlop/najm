...
import { NSidebar } from "../src/components/layout/NSidebar";
import { NSidebarItem } from "../src/components/layout/NSidebarItem";
...
describe("Sidebar", () => {
  ...
  test("collapses from the sidebar header button", () => {
    ...
    expect(desktopSidebar.className).toContain("w-60");
