...
function NFormInner<T extends ZodTypeAny>({ schema, defaultValues, onSubmit, form: externalForm, variant = "default", as = "form", className = "", id, devTools, children }: FormProps<T>) {
