...
export const TimeInput: React.FC<TimeInputProps> = ({ value = "", onChange, placeholder = "", icon, showIcon = true, iconColor, className = "", variant = "default", status = "default", format24 = true, showSeconds = false, disabled = false }) => {
  ...
  return (
    <BaseInput variant={variant} status={currentStatus} className={cn("h-9 gap-2", className)}>
