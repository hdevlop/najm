...
export const TextAreaInput: React.FC<TextAreaInputProps> = ({ value, onChange, placeholder = "", className = "", variant = "default", status = "default", rows }) => (
  <BaseInput variant={variant} status={status} className={cn("items-start", className)}>
    <Textarea
      rows={rows}
