...
export const TextInput: React.FC<TextInputProps> = ({ value, onChange, placeholder = "", icon, showIcon = true, iconColor, className = "", variant = "default", status = "default", disabled = false, ...props }) => {
