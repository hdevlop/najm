...
export function NNavbar({
  ...
  return (
    <header
      className={cn(
        "flex items-center justify-between h-14 px-4 border-b bg-card shrink-0",
        classNames?.navbar,
        className
      )}
    >
      ...
      <div className="flex items-center gap-3">
        {onToggleMobile && (
          <Button variant="ghost" size="icon" onClick={onToggleMobile} className="lg:hidden">
        ...
        {logo && <div className="shrink-0 lg:hidden">{logo}</div>}
        {leftSlot}
