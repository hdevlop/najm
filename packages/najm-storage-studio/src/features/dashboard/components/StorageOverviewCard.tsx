...
export function StorageOverviewCard({ totalBytes, totalCount, categories }: StorageOverviewCardProps) {
  ...
  return (
    <div
      className="flex h-full flex-col rounded-2xl border border-white/[0.06] bg-[#111113] px-5 py-5"
      aria-label={`Storage overview ${formatOverviewBytes(totalBytes)} used across ${totalCount.toLocaleString()} files`}
    >
      <div className="text-center text-sm font-semibold tracking-tight text-white">Storage Overview</div>

      {/* Donut Chart */}
      <div className="relative mx-auto mt-3 h-[180px] w-full max-w-[220px]">
      ...
      {/* Divider */}
      <div className="mx-[-20px] mt-3 h-px bg-white/[0.04]" />

      {/* Category breakdown */}
      <div className="mt-2 flex-1 space-y-0.5 overflow-auto pr-1">
