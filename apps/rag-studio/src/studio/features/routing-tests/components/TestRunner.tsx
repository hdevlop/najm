...
import { NTable, NPageHeader, Button, NSheet, NEmptyState, useLocalStorageState, useContextMenu, useDebouncedValue } from 'najm-kit';
...
export function TestRunner({
  ...
  return (
    <>
      ...
      />
      <div className={testsViewMode === 'json' ? 'flex-1 flex flex-col overflow-hidden' : 'flex-1 overflow-auto'}>
