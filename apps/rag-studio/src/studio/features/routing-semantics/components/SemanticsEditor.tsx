...
import { NPageHeader, NTable, NEmptyState, NSheet, useContextMenu } from 'najm-kit';
  ...
  return (
    <>
      <NPageHeader
        ...
        top={panelTop}
      />
      <div className={semanticsViewMode === 'json' ? 'flex-1 flex flex-col overflow-hidden' : 'flex-1 overflow-auto'}>
