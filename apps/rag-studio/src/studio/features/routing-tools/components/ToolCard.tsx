...
import { Badge, NDataCardShell } from 'najm-kit';
...
export function ToolCard({
  ...
  return (
    <NDataCardShell row={row as unknown as Row<unknown>} onClick={onClick} onContextMenu={onContextMenu} actions={undefined}>
